...
public class OrderRepositoryTest extends ComponentTest {
  ...
  public void shouldFindOneWithGivenDateAndStatusWhenOtherDateIsDifferent() {
    ...
    // this.orderRepository.save(orderToFind);
    ...
    // when
    Set<OrderEntity> foundOrders = this.orderRepository.findAllByCreationDateAndStatus(creationDate, status);
